...
curr1 = input("Enter the currency or country of origin: ")
curr2 = input("Enter the currency or country you want currency convert to:")
a = int(input("Enter the amount: "))

india = ["INR", "inr", "rupees","India","india"]
eu = ["euros","Euro","Euros"]
uk = ["pounds", "Pounds","Uk","UK"]
us = ["Dollars", "dollars","usd","dollar","USA","Usa"]
canada = ["cad dollar", "cad","Canada"]
russia = ["ruble","Russia","russia"]
china = ["yuan","China","china"]
japan = ["yen","Japan","japan"]
